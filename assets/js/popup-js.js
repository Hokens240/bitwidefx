...
r_name[9] = "Gregory";
    ...
    var r_map = new Array ();
r_map[0] = "assets/images/chat (1).png";
r_map[1] = "assets/images/chat (1).png";
r_map[2] = "assets/images/chat (1).png";
r_map[4] = "assets/images/chat (1).png";
r_map[5] = "assets/images/chat (1).png";
r_map[6] = "assets/images/chat (1).png";
